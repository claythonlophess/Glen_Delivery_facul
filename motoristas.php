    ...
    <section class="section dashboard">
      <div class="row">
              ...
              <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
                ...
                <div class="datatable-container">
                  <table class="table table-borderless datatable datatable-table">
                    <thead>
                      <tr>
                        <th data-sortable="true" style="width: 24.375%;"><a href="#" class="datatable-sorter">Motorista</a></th>
                        <th data-sortable="true" style="width: 39.125%;"><a href="#" class="datatable-sorter">Viatura</a></th>
                        <th data-sortable="true" style="width: 15.375%;" aria-sort="ascending" class="datatable-ascending"><a href="#" class="datatable-sorter">Status</a></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr data-index="0">
                        <td>Angus Grady</td>
                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#largeModal" class="text-primar">Ut voluptatem id earum et</a></td>
                        <td><span class="badge bg-danger">Rejected</span></td>
                      </tr>
                      <tr data-index="1">
                        <td>Bridie Kessler</td>
                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#largeModal" class="text-primary">Blanditiis dolor omnis similique</a></td>
                        <td><span class="badge bg-warning">Pending</span></td>
                      </tr>
                      <tr data-index="2">
                        <td>Brandon Jacob</td>
                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#largeModal" class="text-primary">At praesentium minu</a></td>
        ...
        <div class="col-12">
                ...
                <div class="datatable-container">
                  <table class="table table-borderless datatable datatable-table">
                    <thead>
                      <tr>
                        <th data-sortable="true" style="width: 24.375%;"><a href="#" class="datatable-sorter">Motorista</a></th>
                        <th data-sortable="true" style="width: 20.125%;"><a href="#" class="datatable-sorter">Viatura</a></th>
                        <th data-sortable="true" style="width: 20.125%;"><a href="#" class="datatable-sorter">regiao</a></th>
                        <th data-sortable="true" style="width: 15.375%;" aria-sort="ascending" class="datatable-ascending"><a href="#" class="datatable-sorter">Status</a></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      ?>
                        <tr data-index=<?php echo $index ?>>
                          <td><?php echo $dao->registros->nome; ?></td>
                          <td><a href="#" data-bs-toggle="modal" data-bs-target="#motoristas-modal" class="text-primary"><?php echo $dao->registros->senha; ?></a></td>
                          <td><?php echo $dao->registros->nivel; ?></td>
                          <td><span class="badge <?php echo $cor ?>"><?php echo $status; ?></span></td>
                        </tr>
                      <?php
                        $index += 1;
                      }
          ...
          <div class="modal fade" id="motoristas-modal" tabindex="-1" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg modal-dialog-centered">

              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Descricao do Motorista</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
