...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav style="padding-bottom: 40px;">
        <div>
          <h1 class="" style="font-size: 38px;">Maria</h1>
        </div>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6 ">
              <div class=" info-card sales-card card text-center" style=" background: #f6f9ff;border: groove; ">
                <a href="#">
                  <div class="card-body align-items-center">
                    <img src="icons/pizza_100px.png" alt="">
                    <h5 class="card-title" style="font-size: 12px; ">Entregar Comida</h5>
                    <span style="font-size: 12px;">(Ate 10 kg)</span>
                  </div>
                </a>
              ...
              <div class=" info-card sales-card card text-center" style=" background: #f6f9ff; border: groove; ">
                <a href="order.html">
                  <div class="card-body align-items-center">
                    ...
                    <h5 class="card-title" style="font-size: 12px; ">Entregar Pacote</h5>
                    <span style="font-size: 12px;">(Ate 10 kg)</span>
                  </div>
                </a>
              </div>
              ...
              <div class=" info-card sales-card card text-center" style="background: #f6f9ff ;border: groove; ">
                <a href="#">
                  <div class="card-body align-items-center">
                    ...
                    <h5 class="card-title" style="font-size: 12px; ">Entregar Compras</h5>
                    <span style="font-size: 12px;">(Ate 10 kg)</span>
                  </div>
                </a>
        ...
        <div class="col-lg-4">
          <div class="card-body">
            <h5 class="card-title" style="padding-top: 0;">Actividade Recente <span>| Hoje</span></h5>
  ...
  <!-- Vendor JS Files -->
  <script src="http://localhost/NiceAdmin/assets/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="http://localhost/NiceAdmin/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="http://localhost/NiceAdmin/assets/vendor/chart.js/chart.umd.js"></script>
  <script src="http://localhost/NiceAdmin/assets/vendor/echarts/echarts.min.js"></script>
  <script src="http://localhost/NiceAdmin/assets/vendor/quill/quill.min.js"></script>
  <script src="http://localhost/NiceAdmin/assets/vendor/simple-datatables/simple-datatables.js"></script>
  <script src="http://localhost/NiceAdmin/assets/vendor/tinymce/tinymce.min.js"></script>
  <script src="http://localhost/NiceAdmin/assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="http://localhost/NiceAdmin/assets/js/main.js"></script>
